...
def get_pageUrl(start,n,stockid):
    tempurl = 'http://guba.eastmoney.com/list,' + stockid + ',2,f_'
    urls = []
...
def deal_sql(url,stockid):
    ...
    for i in range(n):
        ...
        # time.sleep(sleeptime)
        try:
            sql_main = "insert into report(stockid,readcount,commentcount,publish_date,title,url,content) values " \
...
for stockid in stockid_list:
    ...
    # 爬取到多少页
    start = 1
    #stockids = [""601700","600249","002297","603058","300226","002807","000638","002836","000563","000816","002382","002826","300431","002700","300561","300109","603676","000718","002576","601636","002826","300542","300236","002382","600760","002015","002883","300675",002447","300362","002020" ,"002362",
